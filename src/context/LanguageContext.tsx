...
const allTranslations: Record<Language, Record<string, string>> = {
  uk: {
    ...
    "footer.company_name": "ТОВ «ТЕОН УКРАЇНА»",
    ...
    "contact.hours_days": "Пн – Пт",
    "contact.hours_time": "07:00 – 17:00",
  ...
  en: {
    ...
    "footer.company_name": "TEON UKRAINE LLC",
  ...
  pl: {
    ...
    "footer.company_name": "TEON UKRAINE Sp. z o.o.",
    "company.title": "FIRMA",
    "company.about": "O nas",
