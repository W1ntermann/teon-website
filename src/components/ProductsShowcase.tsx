    ...
    <svg viewBox="0 0 240 200" className="h-full w-full" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="dissGrad" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="100%" stopColor="#0F1F33" stopOpacity="0.95" />
        </linearGradient>
      ...
      <rect x="90" y="28" width="60" height="8" rx="2" fill="#0F1F33" />
      <rect x="90" y="40" width="60" height="4" rx="1" fill="#152B47" />
      {/* Motor housing top */}
      <rect x="95" y="6" width="50" height="22" rx="4" fill="#0F1F33" />
      <rect x="100" y="0" width="40" height="10" rx="3" fill="#152B47" />
      {/* Shaft */}
      ...
      {/* Base */}
      <rect x="60" y="155" width="120" height="12" rx="3" fill="#0F1F33" />
      <rect x="40" y="163" width="160" height="6" rx="2" fill="#0A1628" />
      {/* Speed control panel */}
      ...
      {/* Label */}
      <text x="120" y="182" textAnchor="middle" fill="#1E3A5F" fontSize="9" fontWeight="700" fontFamily="Arial, sans-serif" letterSpacing="2">DISSOLVER</text>
    </svg>
  );
}
...
function BasketMillIllustration() {
  return (
    <svg viewBox="0 0 240 200" className="h-full w-full" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Motor housing top */}
      <rect x="95" y="2" width="50" height="26" rx="4" fill="#0F1F33" />
      <rect x="100" y="0" width="40" height="6" rx="2" fill="#152B47" />
      {/* Main body */}
      <rect x="88" y="20" width="64" height="50" rx="3" fill="url(#basketGrad)" />
      <rect x="93" y="25" width="54" height="5" rx="1" fill="#152B47" />
      {/* Shaft */}
      <rect x="117" y="58" width="6" height="55" rx="2" fill="#5A80A8" />
      {/* Basket mill */}
      <rect x="85" y="105" width="70" height="40" rx="4" fill="#152B47" />
      ...
      {/* Tank */}
      <path d="M55 150 L60 193 L180 193 L185 150 Z" fill="none" stroke="#1E3A5F" strokeWidth="2.5" />
      <path d="M60 155 L62 190 L178 190 L180 155 Z" fill="#1E3A5F" opacity="0.08" />
      {/* Liquid level */}
      <path d="M62 168 L178 168 L180 190 L60 190 Z" fill="#6e7377" opacity="0.15" />
      {/* Grinding media */}
      <circle cx="100" cy="160" r="3" fill="#1E3A5F" opacity="0.5" />
      <circle cx="130" cy="165" r="3.5" fill="#1E3A5F" opacity="0.5" />
      <circle cx="155" cy="158" r="2.5" fill="#1E3A5F" opacity="0.5" />
      <circle cx="115" cy="172" r="2" fill="#1E3A5F" opacity="0.4" />
      <circle cx="145" cy="175" r="3" fill="#1E3A5F" opacity="0.45" />
      {/* Label */}
      <text x="120" y="194" textAnchor="middle" fill="#1E3A5F" fontSize="8" fontWeight="700" fontFamily="Arial, sans-serif" letterSpacing="1.5">BASKET-MILL</text>
    </svg>
  );
}
...
function ButterflyIllustration() {
  return (
    <svg viewBox="0 0 240 200" className="h-full w-full" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Motor top */}
      <rect x="95" y="2" width="50" height="24" rx="4" fill="#0F1F33" />
      <rect x="100" y="0" width="40" height="6" rx="2" fill="#152B47" />
      {/* Body */}
      ...
      {/* Butterfly impeller */}
      <path d="M85 105 Q100 95 120 105 Q140 95 155 105" fill="none" stroke="#1E3A5F" strokeWidth="4" strokeLinecap="round" />
      <path d="M85 105 Q100 115 120 105 Q140 115 155 105" fill="none" stroke="#1E3A5F" strokeWidth="4" strokeLinecap="round" />
      <circle cx="120" cy="105" r="5" fill="#152B47" />
      {/* Tank */}
      <rect x="55" y="120" width="130" height="50" rx="6" fill="none" stroke="#1E3A5F" strokeWidth="2.5" />
      <rect x="58" y="123" width="124" height="44" rx="5" fill="#1E3A5F" opacity="0.06" />
      ...
      {/* Wide anchor */}
      <path d="M65 160 L95 150 L175 150 L175 160" fill="none" stroke="#1E3A5F" strokeWidth="1.5" opacity="0.4" />
      {/* Label */}
      <text x="120" y="185" textAnchor="middle" fill="#1E3A5F" fontSize="7.5" fontWeight="700" fontFamily="Arial, sans-serif" letterSpacing="1.2">BUTTERFLY</text>
    </svg>
  );
}
    ...
    <svg viewBox="0 0 240 200" className="h-full w-full" xmlns="http://www.w3.org/2000/svg">
      <defs>
        ...
        <linearGradient id="flowGrad" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          <stop offset="50%" stopColor="#5A80A8" stopOpacity="0.5" />
      ...
      <rect x="30" y="76" width="180" height="10" rx="2" fill="#0F1F33" />
      {/* Chambers */}
      <rect x="40" y="90" width="50" height="30" rx="3" fill="#0F1F33" />
      <rect x="100" y="90" width="50" height="30" rx="3" fill="#0F1F33" />
      <rect x="160" y="90" width="40" height="30" rx="3" fill="#0F1F33" />
      ...
      {/* Motor */}
      <rect x="195" y="48" width="30" height="24" rx="3" fill="#152B47" />
      {/* Pipe inlet/outlet */}
      <rect x="15" y="95" width="14" height="6" rx="2" fill="#152B47" />
      <rect x="215" y="95" width="14" height="6" rx="2" fill="#152B47" />
      <circle cx="222" cy="98" r="3" fill="#6e7377" />
      {/* Stand */}
      <rect x="55" y="130" width="10" height="35" rx="2" fill="#0F1F33" />
      <rect x="115" y="130" width="10" height="35" rx="2" fill="#0F1F33" />
      <rect x="165" y="130" width="10" height="35" rx="2" fill="#0F1F33" />
      <rect x="40" y="160" width="160" height="5" rx="2" fill="#0A1628" />
      ...
      {/* Label */}
      <text x="120" y="182" textAnchor="middle" fill="#1E3A5F" fontSize="7.5" fontWeight="700" fontFamily="Arial, sans-serif" letterSpacing="1.2">CONTINUOUS-MILL</text>
    </svg>
  );
}
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[#f8f8f8] via-white to-[#f5f5f5] py-14 sm:py-16 md:py-20">
      ...
      <div className="relative mx-auto max-w-[1200px] px-4">
            ...
            return (
              ...
              >
                <Link
                  ...
                  className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-[#e5e5e5] bg-white transition-all duration-300 hover:border-[#1E3A5F]/30 hover:shadow-xl hover:shadow-[#1E3A5F]/5"
                >
                  {/* Illustration Area */}
                  ...
                  <div className="flex flex-1 flex-col p-5 sm:p-6">
                    {/* Category tag */}
                    <span className="mb-2 inline-block text-[10px] font-bold uppercase tracking-[2px] text-[#1E3A5F]/50">
                      {product.category}
                    </span>
                    ...
                    {/* Tagline */}
                    <p className="mb-3 text-[12px] font-medium italic leading-relaxed text-[#1E3A5F]/60 sm:text-[13px]">
                      {product.tagline}
                    </p>
                    ...
                    <div className="mb-4 mt-auto space-y-1.5">
                      {product.features.slice(0, 3).map((feature) => (
                        <div key={feature} className="flex items-center gap-2">
                          <div className="mt-px h-1.5 w-1.5 shrink-0 rounded-full bg-[#1E3A5F]/40" />
                    ...
                    {/* CTA */}
                    <div className="flex items-center gap-1.5 text-[12px] font-bold text-[#1E3A5F] transition-all duration-200 group-hover:gap-2.5 sm:text-[13px]">
                  ...
                  {/* Hover border glow */}
                  <div className="pointer-events-none absolute inset-0 rounded-2xl border-2 border-transparent transition-all duration-300 group-hover:border-[#1E3A5F]/10" />
                </Link>
              </motion.div>
            );
          })}
        ...
        >
          <div className="flex flex-col items-center gap-5 rounded-2xl bg-gradient-to-br from-[#0F1F33] via-[#152B47] to-[#1E3A5F] p-7 text-center sm:flex-row sm:justify-between sm:text-left sm:px-8 sm:py-7 md:px-10 md:py-8">
            <div>
            ...
            <Link
              href="/contact"
              className="inline-flex shrink-0 items-center gap-2 rounded-lg bg-white px-6 py-3 text-[13px] font-bold text-[#1E3A5F] shadow-lg shadow-black/20 transition-all duration-200 hover:bg-[#f0f0f0] hover:shadow-xl"
            >
              {t("products.request")}
              <ArrowRight size={15} />
            </Link>
